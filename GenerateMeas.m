...
%This function produces a set of measurementoperators on Bob_i's side 
%for an input angle theta in the noisy X basis and an input angle 
%phi for a measurement in the noisy Z basis. theta = 0, phi = 0 
...
%measurement choices Bob has to choose from
